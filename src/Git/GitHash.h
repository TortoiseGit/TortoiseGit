...
public:
	...
	static CGitHash FromHexStr(const wchar_t* str, GIT_HASH_TYPE type)
	{
		return FromHexStr(std::wstring_view(str), type);
	}
#endif
	template <typename T>
	static CGitHash FromHexStr(const T& str, GIT_HASH_TYPE type)
	{
