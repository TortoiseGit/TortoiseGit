...
MenuInfo menuInfo[] =
{
	...
	{ ShellMenuGitSVNDCommit,				MENUSVNDCOMMIT,			IDI_COMMIT,			IDS_MENUSVNDCOMMIT,			IDS_MENUSVNDCOMMIT_DESC,
		{ITEMIS_INGIT|ITEMIS_GITSVN, 0}, {ITEMIS_FOLDERINGIT|ITEMIS_GITSVN, 0}, {0, 0}, {0, 0} },
	...
	{ ShellMenuDiff,						MENUDIFF,			IDI_DIFF,				IDS_MENUDIFF,				IDS_MENUDESCDIFF,
		{ITEMIS_INGIT|ITEMIS_ONLYONE, 0}, {ITEMIS_TWO, 0}, {0, 0}, {0, 0} },
	...
	{ ShellMenuStashSave,				    MENUSTASHSAVE,		IDI_COMMIT,				IDS_MENUSTASHSAVE,				IDS_MENUSTASHSAVE,
		{ITEMIS_INGIT|ITEMIS_ONLYONE, 0}, {0, 0}, {0, 0}, {0, 0} },
	...
	{ ShellMenuBisectStart,					MENUBISECTSTART,	0,						IDS_MENUBISECTSTART,		IDS_MENUDESCBISECTSTART,
		{ITEMIS_FOLDERINGIT|ITEMIS_ONLYONE, ITEMIS_BISECT}, {0, 0}, {0, 0}, {0, 0} },

	{ ShellMenuBisectGood,					MENUBISECTGOOD,		IDI_THUMB_UP,			IDS_MENUBISECTGOOD,			IDS_MENUDESCBISECTGOOD,
		{ITEMIS_FOLDERINGIT|ITEMIS_ONLYONE|ITEMIS_BISECT, 0}, {0, 0}, {0, 0}, {0, 0} },

	{ ShellMenuBisectBad,					MENUBISECTBAD,		IDI_THUMB_DOWN,			IDS_MENUBISECTBAD,			IDS_MENUDESCBISECTBAD,
		{ITEMIS_FOLDERINGIT|ITEMIS_ONLYONE|ITEMIS_BISECT, 0}, {0, 0}, {0, 0}, {0, 0} },

	{ ShellMenuBisectReset,					MENUBISECTRESET,	0,						IDS_MENUBISECTRESET,		IDS_MENUDESCBISECTRESET,
		{ITEMIS_FOLDERINGIT|ITEMIS_ONLYONE|ITEMIS_BISECT, 0}, {0, 0}, {0, 0}, {0, 0} },
