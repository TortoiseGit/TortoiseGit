...
MenuInfo menuInfo[] =
{
	...
	{ ShellMenuGitSVNDCommit,				MENUSVNDCOMMIT,		IDI_COMMIT,				IDS_MENUSVNDCOMMIT,			IDS_MENUSVNDCOMMIT_DESC,
		{ITEMIS_INGIT|ITEMIS_GITSVN, ITEMIS_BISECT}, {ITEMIS_FOLDERINGIT|ITEMIS_GITSVN, ITEMIS_BISECT}, {0, 0}, {0, 0} },

	{ ShellMenuGitSVNRebase,				MENUSVNREBASE,		IDI_REBASE,				IDS_MENUSVNREBASE,			IDS_MENUSVNREBASE_DESC,
		{ITEMIS_FOLDERINGIT|ITEMIS_GITSVN|ITEMIS_ONLYONE, ITEMIS_BISECT}, {0, 0}, {0, 0}, {0, 0} },
