...
// Copyright (C) 2008-2014, 2018, 2021, 2023, 2025-2026 - TortoiseGit
...
{
public:
	CGitPropertyPage(const std::vector<std::wstring>& filenames, const CString& projectTopDir, bool bIsSubmodule);
