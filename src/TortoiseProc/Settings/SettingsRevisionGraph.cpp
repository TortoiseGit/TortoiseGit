...
CSettingsRevisionGraph::CSettingsRevisionGraph()
    ...
    , regTrunkPattern (_T("Software\\TortoiseGit\\RevisionGraph\\TrunkPattern"), _T("trunk"))
    , regBranchesPattern (_T("Software\\TortoiseGit\\RevisionGraph\\BranchPattern"), _T("branches"))
    , regTagsPattern (_T("Software\\TortoiseGit\\RevisionGraph\\TagsPattern"), _T("tags"))
    , regTweakTrunkColors (_T("Software\\TortoiseGit\\RevisionGraph\\TweakTrunkColors"), TRUE)
    , regTweakTagsColors (_T("Software\\TortoiseGit\\RevisionGraph\\TweakTagsColors"), TRUE)
