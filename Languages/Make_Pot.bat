...
..\bin\release\bin\ResText extract ..\bin\release\bin\TortoiseProcLang.dll ..\bin\release\bin\TortoiseMergeLang.dll ..\bin\release\bin\TortoiseIDiffLang.dll ..\bin\release\bin\TortoiseGitUDiffLang.dll ..\bin\release\bin\TortoiseGitBlameLang.dll -useheaderfile TortoisePotHeader.txt Tortoise.pot
